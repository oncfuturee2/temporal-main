...
var RetryPolicyMaximumAttempts = dynamicconfig.NewGlobalIntSetting(
	"component.webhooks.retryPolicy.maxAttempts",
	10,
	`The maximum number of attempts for a webhook request.`,
)
	...
	return &Config{
		...
		RetryPolicy: func() backoff.RetryPolicy {
			return backoff.NewExponentialRetryPolicy(
				...
				RetryPolicyMaximumAttempts.Get(dc)(),
			)
		},
	}
}
